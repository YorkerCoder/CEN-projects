...
function p3q2()
    ...
    ua = 35.85 #kcal/min/K
    k0 = 1.7e-4 #m^3/kmol/min
    T0 = 461.0 #K
    Ea = 11273 #cal/mol
    Vl = 5.119 #m^3 volume of liquid
    na0, nb0, nw0 = 9.044, 33.0, 103.7 #kmol
    Ti = 175+273 #K initial temmperature of the reactor
    R = 1.9872 #cal/mol/K
    Ta = 25+273 #K
    #Initial Conditions
    ...
    sol  = solve(prob, Tsit5(), saveat = 0.1, dtmax = 0.05)
...
function p3q2!(du, u, p, t)
    ...
    elseif t>=45.0 && t<=55.0
        ...
        du[5] = dT = (-ΔHr*r*Vl + ua*(Ta-T))/(na*cpa+nb*cpb+nw0*cpw)
    end
